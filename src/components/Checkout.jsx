    ...
    <div className="max-w-7xl mx-auto mt-6 px-4 lg:px-0">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="bg-white rounded-2xl p-6 shadow-lg">
            <div className="flex justify-between items-start">
              <div>
                <h2 className="font-semibold text-lg text-gray-700 mb-2">Alamat Pengiriman</h2>
                <p className="text-gray-500">Jl. Bedahan</p>
                <h2 className="font-semibold text-lg text-gray-700 mt-4 mb-1">Nama Penerima</h2>
          ...
          {/* Detail Produk */}
          <section className="bg-white rounded-2xl p-6 shadow-lg">
            <h2 className="font-bold text-xl mb-2 text-gray-800">Detail Pemesanan</h2>
            <h3 className="text-base font-semibold mb-4 text-Primary">TOKOV</h3>
            <div className="space-y-6">
              {produkList.length === 0 ? (
                <p className="text-center text-gray-500 py-10">Tidak ada produk untuk ditampilkan.</p>
              ) : (
        ...
        <div className="sticky top-0 z-50 bg-white rounded-2xl p-6 shadow-lg h-fit">
          <h2 className="text-lg font-bold mb-4 text-center text-gray-800">Metode Pembayaran</h2>
          ...
          <div id="listPembayaran" className="flex flex-col space-y-4 font-medium text-gray-700 cursor-pointer">
